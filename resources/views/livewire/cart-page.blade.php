  ...
  <div class="container mx-auto px-4">
    ...
    <div class="flex flex-col md:flex-row gap-4">
      <div class="md:w-3/4">
        ...
        class="bg-slate-300 border-2 border-slate-400 rounded-lg px-3 py-1 transition duration-150 ease-in-out 
               hover:bg-red-600 hover:text-white hover:border-red-700 focus:outline-none focus:ring-2 
               focus:ring-red-500 focus:ring-opacity-50 text-gray-700">
