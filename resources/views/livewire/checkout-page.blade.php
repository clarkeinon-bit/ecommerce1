            ...
            <div class="md:col-span-12 lg:col-span-8 col-span-12">
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                class="w-full rounded-lg border border-gray-300 py-2 px-3 
                                    ...
                                    @error('first_name') !border-red-500 focus:!border-red-500 @enderror" 
                                    id="first_name" 
                                    type="text"
                            ...
                            <div>
                                ...
                                class="w-full rounded-lg border border-gray-300 py-2 px-3 
                                    dark:bg-gray-700 dark:text-white dark:border-gray-600 
                                    @error('last_name') !border-red-500 focus:!border-red-500 @enderror" 
                                    id="last_name" 
                                    type="text"
                        ...
                        <div class="mt-4">
                            ...
                            <input 
                                ...
                                class="w-full rounded-lg border border-gray-300 py-2 px-3 
                                    dark:bg-gray-700 dark:text-white dark:border-gray-600 
                                    @error('phone') !border-red-500 focus:!border-red-500 @enderror" 
                                    id="phone" 
                                    type="text"
                        ...
                        <div class="mt-4">
                            ...
                            <input 
                                wire:model.live ='street_address' 
                                class="w-full rounded-lg border border-gray-300 py-2 px-3 
                                    dark:bg-gray-700 dark:text-white dark:border-gray-600 
                                    @error('street_address') !border-red-500 focus:!border-red-500 @enderror" 
                                    id="street_address" 
                                    type="text"
                        ...
                        <div class="mt-4">
                            ...
                            <input 
                                ...
                                class="w-full rounded-lg border border-gray-300 py-2 px-3 
                                    dark:bg-gray-700 dark:text-white dark:border-gray-600 
                                    @error('city') !border-red-500 focus:!border-red-500 @enderror" 
                                    id="city" 
                                    type="text"
                                    autocomplete="address-level2" {{-- Added Autocomplete --}}
                            />
                            @error('city')
                            <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                class="w-full rounded-lg border border-gray-300 py-2 px-3 
                                    dark:bg-gray-700 dark:text-white dark:border-gray-600 
                                    @error('state') !border-red-500 focus:!border-red-500 @enderror" 
                                    id="state" 
                                    type="text"
                                    autocomplete="address-level1" {{-- Added Autocomplete --}}
                                />
                                @error('state')
                                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            ...
                            <div>
                                ...
                                class="w-full rounded-lg border border-gray-300 py-2 px-3 
                                    dark:bg-gray-700 dark:text-white dark:border-gray-600 
                                    @error('zip_code') !border-red-500 focus:!border-red-500 @enderror" 
                                    id="zip_code" 
                                    type="text"
                                    autocomplete="postal-code" {{-- Added Autocomplete --}}
                                />
                                @error('zip_code')
                                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                @enderror
                    ...
                    <ul class="grid w-full gap-6 md:grid-cols-2">
                        <li>
                            {{-- REMOVED `required` and ADDED `name` --}}
                            <input 
                                ...
                                type="radio" 
                                value="cod"
                                name="payment_method" {{-- IMPORTANT: Added name for grouping --}}
                            />
