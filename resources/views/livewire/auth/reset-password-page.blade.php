        ...
        <div class="p-4 sm:p-7">
          ...
          <div class="mt-5">
            ...
            <form wire:submit.prevent="save">
              @if (session('error'))
        {{-- FIX: Check for 'success' and style it as green --}}
        <div class="mt-2 bg-red-500 text-sm text-white rounded-lg p-4 mb-4" role="alert" tabindex="-1" aria-labelledby="hs-solid-color-success-label">
            {{ session('error') }}
        </div>
    @endif
                <div class="grid gap-y-4">
                    ...
                    <!-- Hidden Token Field -->
                    <!-- This field is needed to submit the token to the server -->
                    ...
                    <!-- Password Field (as per your previous code) -->
                    <div>
                    ...
                    <!-- Confirm Password Field (as per your previous code) -->
                    <div>
